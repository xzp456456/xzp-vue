			...
			<div class="info_item">
				...
				<div class="list">
					<div class="row">
						...
						<div class="pull-right">
							<input type="text" name="" id="" value="" placeholder="请填写您的姓名" />
						</div>
					</div>
				</div>
				<div class="list">
					<div class="row">
						...
						<div class="pull-right">
							<input type="text" name="" id="" value="" placeholder="请填写联系电话" />
						</div>
					</div>
				</div>
				<div class="list">
					<div class="row">
						...
						<div class="pull-right">
							<input type="text" name="" id="" value="" placeholder="请填写您的详细地址" />
						</div>
					</div>
				</div>
				<div class="list">
					<div class="row">
						...
						<div class="pull-right name_text">
							<span class="text">5米内</span><img src="../assets/img/in.png"/>
						</div>
					</div>
				</div>
				<div class="list">
					<div class="row">
						...
						<div class="pull-right name_text">
							<span class="text">是</span><img src="../assets/img/in.png"/>
						</div>
					</div>
				</div>
				<div class="list">
					<div class="row">
						...
						<div class="pull-right name_text">
							<span class="text">台面</span><img src="../assets/img/in.png"/>
						</div>
					</div>
				</div>
				<div class="list">
